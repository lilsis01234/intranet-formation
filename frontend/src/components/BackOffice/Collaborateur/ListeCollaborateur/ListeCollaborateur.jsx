...
//recherche globale 
  ...
  const [rechercheProjet, setRechercheProjet] = useState('null');
  ...
  const [globalSearchResults, setGlobalSearchResults] = useState([]);
    ...
    const fetchCollaborateur = () => {
      axios.get('http://192.168.16.244:4000/api/collaborateur/all')
  ...
  const handleSearch = () => {
    ...
    const filteredCollab = allCollab.filter(collab => {
      return (
        ...
        (collab.projet1.nomProjet.toLowerCase().includes(recherche.toLowerCase())) ||
              ...
              <table className="w-full min-w-max table-auto text-left text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type='text' id='filtre' className="add-input" placeholder="Projet" onChange={(e) => setRechercheProjet(e.target.value)} /></td>
                  ...
                  {recherche === '' ? (listeCollab.filter(collaborateur => (
                    ...
                    (rechercheProjet === 'null' || collaborateur.projet1.nomProjet.toLowerCase().includes(rechercheProjet.toLowerCase())) &&
                    (recherchedepartement === 'null' || collaborateur.departement1.nomDepartement.toLowerCase().includes(recherchedepartement.toLowerCase()))
                      ...
                      <tr key={collaborateur.id}>
                          <td><Avatar src={`http://192.168.16.244:4000/${collaborateur.image}`} alt={collaborateur.nom}  size="xs" className="rounded-full w-15 h-12  object-cover"/></td>
                          <td>{collaborateur.matricule}</td>
                          <td>{collaborateur.nom}</td>
                          <td>{collaborateur.prenom}</td>
                          <td>{collaborateur.poste1.titrePoste}</td>
                          <td>{collaborateur.projet1.nomProjet}</td>
