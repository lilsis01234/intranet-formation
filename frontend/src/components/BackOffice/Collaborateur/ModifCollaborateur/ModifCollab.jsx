...
const ModifCollab = ({ CollabToEdit, onCollabUpdated }) => {
    ...
    const [projet, setProjet] = useState(CollabToEdit?.projet || '');
    const [projet2, setProjet2] = useState(CollabToEdit?.projet2 || '');
    ...
    useEffect(() => {
        if (CollabToEdit) {
            ...
            setProjet(CollabToEdit.projet1?.id)
            setProjet2(CollabToEdit.projet2?.id)
        } else {
            setNom("")
            setPrenom("")
            setImage("")
                ...
                <div className="flex flex-col  ml-10 pl-10 ">
                    ...
                    <div className="grid grid-cols-12 my-5">
                        ...
                        <div className="col-span-4 mr-2 ">
                            <Select
                                label="Projet"
                                onChange={(e) => setProjet(e)}
                            >
                                {listeProjet.map((projet) => (
                                    <Option key={projet.id} value={projet.id.toString()}>{projet.nomProjet}</Option>
                                ))}
